...
export default function Home({ trending , popular , top , upcoming}) {
  return (
    <div className="container">
      ...
      <div className="list">
        <Divider className="list-text-heading" aria-orientation="vertical" >Comings Movies</Divider>
        <CarouselComing upcoming={upcoming} />
      </div>
      <div className="list">
        <Divider className="list-text-heading" aria-orientation="vertical" >Top Rate Movies</Divider>
        <CarouselTop top={top} />
      </div>
      <div className="list">
        <Divider className="list-text-heading" aria-orientation="vertical" >Popular Movies</Divider>
